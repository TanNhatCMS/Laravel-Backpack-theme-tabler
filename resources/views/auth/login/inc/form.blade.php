...
<h2 class="h2 text-center my-4">{{ trans('tannhatcms::base.login') }}</h2>
<form method="POST" action="{{ route('backpack.auth.login') }}" autocomplete="off" novalidate="">
    @csrf
    <div class="mb-3">
        <label class="form-label" for="{{ $username }}">{{ trans('tannhatcms::base.'.strtolower(config('backpack.base.authentication_column_name'))) }}</label>
    ...
    <div class="mb-2">
        <label class="form-label" for="password">
            {{ trans('tannhatcms::base.password') }}
        </label>
        <div class="input-group input-group-flat password-visibility-toggler">
            ...
            <span class="input-group-text p-0 px-2">
                <a href="#" data-input-type="text" class="link-secondary p-2" data-bs-toggle="tooltip" aria-label="{{ trans('tannhatcms.theme-tabler::theme-tabler.password-show') }}" data-bs-original-title="{{ trans('tannhatcms.theme-tabler::theme-tabler.password-show') }}">
                    <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-eye" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"></path><path d="M10 12a2 2 0 1 0 4 0a2 2 0 0 0 -4 0"></path><path d="M21 12c-2.4 4 -5.4 6 -9 6c-3.6 0 -6.6 -2 -9 -6c2.4 -4 5.4 -6 9 -6c3.6 0 6.6 2 9 6"></path></svg>
                </a>
                <a href="#" data-input-type="password" class="link-secondary p-2 d-none" data-bs-toggle="tooltip" aria-label="{{ trans('tannhatcms.theme-tabler::theme-tabler.password-hide') }}" data-bs-original-title="{{ trans('tannhatcms.theme-tabler::theme-tabler.password-hide') }}">
    ...
    <div class="d-flex justify-content-between align-items-center mb-2">
        <label class="form-check mb-0">
            ...
            <span class="form-check-label">{{ trans('tannhatcms::base.remember_me') }}</span>
        </label>
        @if (backpack_users_have_email() && backpack_email_column() == 'email' && config('backpack.base.setup_password_recovery_routes', true))
            <div class="form-label-description">
                <a tabindex="4" href="{{ route('backpack.auth.password.reset') }}">{{ trans('tannhatcms::base.forgot_your_password') }}</a>
            </div>
        @endif
    </div>
    <div class="form-footer">
        <button tabindex="5" type="submit" class="btn btn-primary w-100">{{ trans('tannhatcms::base.login') }}</button>
    </div>
</form>
